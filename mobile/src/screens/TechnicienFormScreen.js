...
// Le matricule est auto-généré et n'apparaît pas dans le formulaire
...
export default function TechnicienFormScreen() {
  ...
  // =========================================================
  // GÉNÉRATION AUTO DU MATRICULE (en arrière-plan)
  // =========================================================
  ...
  }, [nom, prenom, email, telephone, specialite, zoneIntervention, motDePasse, validateField]);
  ...
  const handleSave = async () => {
    ...
    // Le matricule est auto-généré, on l'utilise tel quel
    if (!matricule) {
      Alert.alert('Erreur', 'Matricule non généré.');
      return;
    }
